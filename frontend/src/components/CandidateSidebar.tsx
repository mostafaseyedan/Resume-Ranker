...
const CandidateSidebar: React.FC<CandidateSidebarProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-surface shadow-sm border border-gray-200 dark:border-line">
      {/* Header Section */}
      <div className="p-4 border-b dark:border-line">
