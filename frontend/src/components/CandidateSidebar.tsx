...
import { type GroupedCandidate } from '@/utils/groupCandidates';
...
const CandidateSidebar: React.FC<CandidateSidebarProps> = ({
  ...
  return (
    <div className="flex flex-col h-full min-h-0 bg-white dark:bg-surface">
      <div className="p-4 border-b border-gray-200 dark:border-line">
        <div className="flex items-center gap-2 text-sm text-gray-700 dark:text-ink">
          {/* Search */}
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          <div className="p-4 text-center text-gray-500 dark:text-ink-muted">
            <div className="animate-spin h-6 w-6 border-2 border-brand border-t-transparent rounded-full mx-auto mb-2"></div>
          ...
          <div className="divide-y divide-gray-200 dark:divide-line">
            {filteredCandidates.map((candidate) => {
              ...
              return (
                <div
                  ...
                  className={`p-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-surface-hover transition-colors ${
                    isSelected ? 'bg-brand-soft/60 dark:bg-brand/15 border-r-2 border-brand' : ''
                  }`}
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-medium text-gray-900 dark:text-ink truncate">{candidate.name}</h3>
                  ...
                  {/* Job Info */}
                  <div className="mt-2 text-xs text-gray-500 dark:text-ink-muted">
                    ...
                    {candidate.jobTitles.length > 0 && (
                      <div className="mt-1 truncate text-gray-400 dark:text-ink-muted">
      ...
      {/* Footer with count */}
      <div className="p-3 border-t dark:border-line text-xs text-gray-500 dark:text-ink-muted text-center">
